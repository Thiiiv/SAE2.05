...
<body>
    ...
    <div class="flexboxcolonne">
        <div id="fond" style="background-image: url('../data/images/monuments/medinafond.jpg');">>
        ...
        <div id="content" class="partie">
            ...
            <div class="contenu droite">
                ...
                <img src="../data/images/monuments/medinahistoire.jpg">
            </div>
        ...
        <div class="partie">
            ...
            <div class="contenu gauche">
                <img src="../data/images/monuments/medinarchitecture.jpg">
