...
<head>
    ...
    <link rel="shotcut icon" href="../data/image/favicon.png">
...
<body>
    ...
    <div class="flexboxcolonne">
        <div id="fond" style="background-image: url('../data/images/monuments/mosqueefond.jpg');">
            ...
            <a style="margin-top: 75vh;" href="#content"><img id="flechebas" class="shake-vertical"
                    src="../data/images/flecheversbas.png"></a>
        </div>
        ...
        <div id="content" class="partie">
            ...
            <div class="contenu droite">
                ...
                <img src="../data/images/monuments/mosqueehistoire.jpg">
            </div>
        ...
        <div class="partie">
            ...
            <div class="contenu gauche">
                <img src="../data/images/monuments/mosqueearchitecture.jpg">
