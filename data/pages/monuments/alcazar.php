...
<head>
    ...
    <title><?php echo $translations["alcazar"] ?></title>
</head>
...
<body>
    ...
    <div class="flexboxcolonne">
        <div id="fond" style="background-image: url('../../images/monuments/alcazarfond.jpg');">
            ...
            <h1><?php echo $translations["alcazar"] ?></h1>
        ...
        <div id="content" class="partie">
            ...
            <div class="contenu droite">
                <p><?php echo $translations["alcazar_hist"] ?></p>
        ...
        <div class="partie">
            ...
            <div class="contenu gauche">
                ...
                <p><?php echo $translations["alcazar_arch"] ?></p>
            </div>
        </div>
    </div>
